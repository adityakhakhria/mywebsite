...
window.Typekit.config = {
    "a": "1160068",
    "c": [".tk-proxima-nova", "\"proxima-nova\",sans-serif", ".tk-proxima-nova-sc-osf", "\"proxima-nova-sc-osf\",sans-serif"],
    "dl": "AAAAdAAAAAqv1Xgi6-AOsszoO4UABMtB",
    "fi": [139, 140, 175, 176, 10681, 10685, 10881, 10884, 15760, 22737],
    "fc": [{
        "id": 139,
        "family": "proxima-nova",
        "src": "{scheme}://{hostname}/af/03034e/00000000000000003b9ad1b1/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "primer": "c1627fd7b7efc3ea862ea124732198613672ed60d7d14b8606daecd7d2df956d"
        }
    }, {
        "id": 140,
        "family": "proxima-nova",
        "src": "{scheme}://{hostname}/af/5a684a/00000000000000003b9ad1b2/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "700",
            "style": "italic",
            "primer": "c1627fd7b7efc3ea862ea124732198613672ed60d7d14b8606daecd7d2df956d"
        ...
        "id": 175,
        "family": "proxima-nova",
        "src": "{scheme}://{hostname}/af/edab9a/00000000000000003b9ad1b9/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "primer": "c1627fd7b7efc3ea862ea124732198613672ed60d7d14b8606daecd7d2df956d"
        ...
        "id": 176,
        "family": "proxima-nova",
        "src": "{scheme}://{hostname}/af/1b9fb4/00000000000000003b9ad1ba/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "primer": "c1627fd7b7efc3ea862ea124732198613672ed60d7d14b8606daecd7d2df956d"
        ...
        "src": "{scheme}://{hostname}/af/f1eb62/00000000000000003b9ad211/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "primer": "a0674a07fdfcc6cc36b55442a8e770017eef7ca95e467138a8d0608041297be7"
        }
    }, {
        "id": 10685,
        "family": "proxima-nova-sc-osf",
        "src": "{scheme}://{hostname}/af/9d67b3/00000000000000003b9ad219/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "primer": "a0674a07fdfcc6cc36b55442a8e770017eef7ca95e467138a8d0608041297be7"
        ...
        "id": 10881,
        "family": "futura-pt",
        "src": "{scheme}://{hostname}/af/90cf9f/000000000000000000010091/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "primer": "a0674a07fdfcc6cc36b55442a8e770017eef7ca95e467138a8d0608041297be7"
        ...
        "id": 10884,
        "family": "futura-pt",
        "src": "{scheme}://{hostname}/af/8a5494/000000000000000000013365/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "primer": "a0674a07fdfcc6cc36b55442a8e770017eef7ca95e467138a8d0608041297be7"
        ...
        "id": 15760,
        "family": "merriweather",
        "src": "{scheme}://{hostname}/af/f20d56/000000000000000000014a3e/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "primer": "c1627fd7b7efc3ea862ea124732198613672ed60d7d14b8606daecd7d2df956d"
        ...
        "id": 22737,
        "family": "merriweather",
        "src": "{scheme}://{hostname}/af/f87f0c/000000000000000000014a3d/27/{format}{?primer,subset_id,fvd,token}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "primer": "c1627fd7b7efc3ea862ea124732198613672ed60d7d14b8606daecd7d2df956d"
    ...
    "fn": ["futura-pt", ["n4", "n7"], "merriweather", ["i4", "n4"], "proxima-nova", ["i4", "i7", "n4", "n7"], "proxima-nova-sc-osf", ["n4", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.18.13",
    "kt": "uqr2sij",
    ...
    "p": "p.typekit.net",
    "ps": 1,
    "token": "0hgxRfDNMQCiCpTBNsJSsnJ5s0TJeuq6MfFsek8iB3v4XJ5FG6Tk796l3Nld/6q2zbLAQM8BvA4j2PrhJabDVVjR4I26f1DhYCjesotY/wsgkPTDsWd/h2unMv4gzJpMl+2mpEjmCewQz0qCxsP88j0N7aatWplWgSZCqs6R7rwf7fM6HOs4Bw7XwQbp5VhFRKve1QEiuTnMU1QqA6u1ig==",
    "type": "configurable"
};
/*{"k":"1.18.13","auto_updating":true,"last_published":"2016-08-13 19:04:31 UTC"}*/
;
(function(window, document, undefined) {
    ...
    fa.prototype.has = function(a) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.i; c++) {
            var d;
            if (b)
                d = r(a & 4294967295, 3432918353), d = d << 15 | d >>> 17, d = r(d, 461845907), d ^= ga[c] || 0, d = d << 13 | d >>> 19, d = r(d, 5) + 3864292196, d ^= 4, d ^= d >>> 16, d = r(d, 2246822507), d ^= d >>> 13, d = r(d, 3266489909), d ^= d >>> 16, d = (d >>> 0) % this.b;
            else {
                d = ga[c] || 0;
                var e,
                    f,
    ...
    function Fa(a, b) {
        if (a.b.length) {
            for (var c = new la(a.g, b, {}), d = 0; d < a.b.length; d++)
                a.b[d].init();
    ...
    if (n.fc)
        for (var X = n.fc, Z = 0; Z < X.length; Z++)
